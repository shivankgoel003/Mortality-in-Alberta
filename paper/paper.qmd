---
title: "Respiratory Related Deaths Show Positive Relation to Increasing Air Pollution"
...
```
```{r}
#| label: fig-fakeprediction
#| fig-cap: Prediction of deaths based on the model
#| echo: false
#| warning: false
#| message: false
