...
# library(bayesplot)
# 
# ppc <- pp_check(p_average_model, type = "dens_overlay")
# 
# # Add a classic theme to the plot
# #ppc + theme_classic()
# 
# # Print the plot
# print(ppc)
# Create the posterior predictive check plot with the specified theme
pp_plot <- pp_check(p_average_model, theme = theme_classic()) +
  theme(legend.position = "bottom")

# Create the posterior vs prior plot with the specified theme
posterior_plot <- posterior_vs_prior(p_average_model, theme = theme_minimal()) +
